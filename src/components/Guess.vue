...
import type { GoodsGuessLikeResponse } from '@/types/home'
...
const getHomeGoodsGuessLikeData = async () => {
  try {
    ...
    if (res.result.pages >= pageParams.value.page) {
...
<template>
  ...
  <view class="loading-text" v-if="pageParams.page <= total"> 正在加载... </view>
</template>
